...
const CreateContainer = () => {
  ...
  const [calories, setCarlories] = useState("");
      ...
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
                  ...
                  ( <>
                      ...
                      <>
                        <div className='relative h-full'>
                          ...
                          outline-none hover:shadow-md duration-500 transition-all ease-in-out' onClick={deleteImage}>
          ...
          <div className='w-full flex flex-col md:flex-row items-center gap-3'>
            <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
              ...
              outline-none placeholder:text-gray-500 text-textColor" />
            </div>
            ...
            <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
              ...
              placeholder="Price" 
              className="w-full h-full text-lg bg-transparent 
              outline-none placeholder:text-gray-400 text-textColor" />
            </div>
          </div>
